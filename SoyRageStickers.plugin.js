 ...
 * @source https://raw.githubusercontent.com/SoyRage/DiscordNitroBypassPlugins/main/SoyRageStickers.plugin.js
...
const BaseColor = "#f0c";
var Utils = {
    Log: (message) => { console.log(`%c[SoyRageStickers] %c${message}`, `color:${BaseColor};font-weight:bold`, "") },
    Warn: (message) => { console.warn(`%c[SoyRageStickers] %c${message}`, `color:${BaseColor};font-weight:bold`, "") },
    Error: (message) => { console.error(`%c[SoyRageStickers] %c${message}`, `color:${BaseColor};font-weight:bold`, "") }
};
...
BdApi.Patcher.instead('SoyRageStickers', StickerSendabilityModule, 'isSendableSticker', (thisObject, methodArguments, originalMethod) => {
...
BdApi.Patcher.instead('SoyRageStickers', MessageQueue, 'enqueue', (thisObject, methodArguments, originalMethod) => {
...
BdApi.Patcher.after('SoyRageStickers', XhrClient, 'post', (thisObject, methodArguments, result) => {
...
BdApi.Patcher.instead('SoyRageStickers', StickerHelpers, 'useFilteredStickerPackCategories', (thisObject, methodArguments, originalMethod) => {
...
function Stop() {
    BdApi.Patcher.unpatchAll('SoyRageStickers');
    Utils.Log("Stopped!");
}
...
module.exports = SoyRageStickers;
